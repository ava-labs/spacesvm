...
verify signatures generated by Web3 wallets, it itself is not an EVM nor an
EVM derivative.** SpacesVM was written from scratch to optimize for spaces interactions.
It supports EIP-712 (`eth_signTypedData`) signature recovery so you don't need
to download another wallet to give it a spin.
